    ...
    var ResizePlugin = /** @class */ (function () {
        ...
        ResizePlugin.prototype.positionResizerToTarget = function (el) {
            ...
            try {
                ...
                var borderLeftWidth = parseInt(computedStyle.borderLeftWidth, 10) || 0;
                var borderRightWidth = parseInt(computedStyle.borderRightWidth, 10) || 0;
                var borderTopWidth = parseInt(computedStyle.borderTopWidth, 10) || 0;
                var borderBottomWidth = parseInt(computedStyle.borderBottomWidth, 10) || 0;
                // Calculate total dimensions including borders
                var totalWidth = el.clientWidth + borderLeftWidth + borderRightWidth;
                var totalHeight = el.clientHeight + borderTopWidth + borderBottomWidth;
       ...
       */
        ResizePlugin.prototype.generateToolbarHTML = function () {
            ...
            var isVideoElement = this.resizeTarget instanceof HTMLVideoElement ||
        ...
        ResizePlugin.prototype.startResize = function (e) {
            ...
            if (target.classList.contains("handler") && e.which === 1) {
                ...
                var computedStyle = window.getComputedStyle(this.resizeTarget);
                var borderLeftWidth = parseInt(computedStyle.borderLeftWidth, 10) || 0;
                var borderRightWidth = parseInt(computedStyle.borderRightWidth, 10) || 0;
                var borderTopWidth = parseInt(computedStyle.borderTopWidth, 10) || 0;
                var borderBottomWidth = parseInt(computedStyle.borderBottomWidth, 10) || 0;
        ...
        ResizePlugin.prototype.resizing = function (e) {
            ...
            var contentWidth = width - borderLeftWidth - borderRightWidth;
            var contentHeight = height - borderTopWidth - borderBottomWidth;
            ...
            var newContentHeight = aspectRatio * newContentWidth;
            // Apply minimum size (to content dimensions)
            var finalContentWidth = Math.max(newContentWidth, 30);
            var finalContentHeight = Math.max(newContentHeight, 30);
